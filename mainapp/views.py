...
from .models import Category, Order, CartProduct, Customer, Product
...
class ChangeQTYView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        cart_product.save()
        recalc_cart(self.cart)
        messages.add_message(request, messages.INFO, "Count changed successfully")
        return HttpResponseRedirect('/cart/')
